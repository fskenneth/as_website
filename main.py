...
# tools.user_db imports not needed here; Stripe callbacks that still touch
# the customer DB are imported locally where used.
...
# /item_management mount moved to as_webapp/main.py
# /zoho_sync mount moved to as_webapp/main.py

# Background sync tasks (page sync, Zoho write sync, multi-report sync) moved
# to as_webapp/main.py in Phase 3. main.py stays slim and public-facing.


# /api/v1/* routes extracted to as_webapp/as_portal_api/routes.py (Phase 1).
...
# get_current_user helper moved to as_webapp/portal_web/routes.py

# /api/auth/* moved to as_webapp/portal_web/routes.py

# /api/profile/update moved to as_webapp/portal_web/routes.py

# /api/stagings* moved to as_webapp/portal_web/routes.py

# /api/inventory-items moved to as_webapp/portal_web/routes.py

# /api/save-default-rotation + /api/get-default-rotation moved to as_webapp/portal_web/routes.py
...
# /api/staging-photos/cleanup moved to as_webapp/portal_web/routes.py

# /api/save-staging-models + /api/get-staging-models moved to as_webapp/portal_web/routes.py
# register_test_routes(rt) moved to as_webapp/portal_web/routes.py
...
# /api/admin/users* moved to as_webapp/portal_web/routes.py
...
# /api/client-log* moved to as_webapp/portal_web/routes.py
...
# /test (inpainting) moved to as_webapp/portal_web/routes.py
...
# /signin + /portal moved to as_webapp/portal_web/routes.py
